        	...
        	<div class="col-xl-6 offset-xl-3 col-sm-12 mb-3">
        		<ul class="list-group">
				  <li class="list-group-item d-flex justify-content-between align-items-center">
				    <a href="{{ route('incomes.create') }}" class="badge badge-success p-2" style="margin:0 0 0 auto;">Add New Income</a>
				  </li>
				  <li class="list-group-item d-flex justify-content-between align-items-center">
				    Total Income
                    ...
                    <div class="card text-white bg-info o-hidden h-100">
                        ...
                        <div class="card-header">
                            ...
                            <span class="btn-group-sm float-right">
                                ...
                                <span class="btn btn-sm btn-danger c_pointer"><i class="fa fa-trash"></i></span>
                            </span>
                        </div>
