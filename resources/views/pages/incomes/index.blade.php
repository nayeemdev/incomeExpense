        		...
        		<ul class="list-group">
				  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <div class="input-group" style="max-width:250px">
                        ...
                        <select class="form-control" onchange="location.href='/incomes/period/'+this.value"> {{-- TODO: ideally, this dropdown generated using javascript --}}
                ...
                <div class="col-xl-4 col-sm-6 mb-3">
                    ...
                    <div class="card text-white bg-info o-hidden h-100">
                        ...
                        <div class="card-header">
                            <span class="float-left text-dark">{{ $income->income_date->format(config('setting.date_format')) }}</span>
